VATCalculatorApp.controller("VATCalculatorCtrl", function($scope, $http, $log){
    "use strict";
    ...
    function createFileListTable(){
        $scope.gridOptions = {
            ...
            columnDefs: [
                {field:'principle', displayName:'Principle'},
                {field:'vat', displayName:'VAT'},
                {field:'caluratedDateTime', displayName:'Date'}
            ]
        };
    }

    $scope.calculateVAT = function(principle){
        $scope.VAT = (principle /11).toFixed(2) ;
    }
});
